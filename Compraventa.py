...
class Compraventa(Contrato):
    ...
    def __str__(self):
        printer = "Compraventa: {"+"codigo: "+str(self._codigo)+", fecha: "+str(self._fecha)+", costo total: "+str(self._valor)+", inmueble: "+str(self._inmueble.__str__())+", comprador: "+str(self._comprador)+" }"
        return printer
